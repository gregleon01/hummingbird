...
Whisper-based macOS overlay for voice-driven coding instructions.
...
to your clipboard via a single “Copy” action.
...
- Clipboard copy button keeps transcripts out of the UI until you want them.
...
3. Press **Copy** to push the transcript to your clipboard.
4. Use `Control+Option+M` at any time to hide or reshow the overlay.
